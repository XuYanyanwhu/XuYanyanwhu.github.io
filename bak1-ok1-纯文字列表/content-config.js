...
window.teacherHomeConfig = {
  page: {
    ...
    description: "徐彦彦教授个人主页，研究方向包括地理信息安全、智能网络通信、空间信息实时传输。"
  },
  nav: [
  ...
  hero: {
    ...
    tags: ["地理信息安全", "智能网络通信", "空间信息实时传输"],
    intro: "主要从事地理信息安全、智能网络通信、空间信息实时传输等方向研究。主持国家自然科学基金、国家重点研发计划子课题、国家自然科学基金委重大研究计划子课题等多项课题，公开发表学术论文 70 余篇，出版学术专著 1 部，授权国家发明专利多项。",
    actions: [
  ...
  profile: {
    ...
    title: "个人简介",
    paragraphs: [
      "徐彦彦，女，博士，教授，博士生导师，武汉大学测绘遥感信息工程全国重点实验室 3S 集成与网络通信研究室副主任，中国地理信息安全技术工作委员会副主任委员，中国交通信息化交通通信与信息安全专委会委员，中国光谷 3551 创新人才。主持国家自然科学基金三项、国家重点研发计划子课题三项、国家自然科学基金委重大研究计划子课题一项、国家 973 计划子课题一项，主持或参与省部级纵向及横向项目二十余项。"
    ],
  ...
  research: {
    ...
    items: [
      {
        title: "地理信息安全",
        description: "研究地理信息在存储、传输和处理过程中的安全问题，包括数据加密、访问控制和隐私保护等。",
        tags: ["Geographic Information Security", "Data Encryption", "Access Control"]
      },
      {
        title: "空间信息实时传输",
